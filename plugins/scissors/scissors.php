<?php
/*
Plugin Name: Scissors
Plugin URI: http://vimeo.com/7363026
Description: Scissors enhances WordPress' handling of images by introducing cropping, resizing, rotating, and watermarking functionality.
Version: 1.3.7
Author: Stephan Reiter
Author URI: http://stephanreiter.info/
...
{
	// Sorry, WordPress 2.9 and newer are not supported!
	// Please check out the integrated image editor I was invited to
	// contribute to ...
	//     Stephan, December 2009
}
else
{
...
function scissors_media_meta($string, $post)
{
	...
	else
	{
		...
		$string .= "<span id='scissorsSize-$postId'>$img_size</span></td></tr>\n\t\t<tr>";
		$string .= "<th valign='top' scope='row' class='label'><label>Scissors</label></th><td class='field'>";
